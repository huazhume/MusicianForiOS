//
//  CateDetailTableViewController.m
//  Moment
//
//  Created by lenservice on 16/3/10.
...
@interface CateDetailTableViewController ()<MAVAudioPlayerDelegate>
...
@implementation CateDetailTableViewController
...
-(void)refreshNomalHeader{
    __block CateDetailTableViewController * blockSelf = self;
...
-(void)refreshData{
    ...
    } byCurrentTime:[CurrentTimeSerVice getCurrentTime] andResourceNumber:self.topicNum andPageIndex:_pageIndex];
...
-(void)registNotification{
    ...
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(audioOperate:) name:@"AUDIO_START" object:nil];

}
#pragma mark -
#pragma mark -  销毁通知
-(void)freeNotification{
    [[NSNotificationCenter defaultCenter]removeObserver:self name:@"AUDIO_START" object:nil];
}
